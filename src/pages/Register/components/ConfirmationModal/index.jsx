...
export function ConfirmationModal({
	...
	return (
		<Modal isOpen={openModal} className="react-modal-content" overlayClassName="react-modal-overlay">
			<div>
				<p>Falta só mais um passo:</p>
				<p>
              Por favor, acesse seu e-mail [email@email.com.br] e procure o
              nosso e-mail de Confirmação de cadastro.
				</p>
				<p>
              Ele pode estar na sua caixa de entrada ou de spam/lixo eletrônico.
				</p>
				<p>
              Aí é só abrir, clicar no link e estaremos prontos pra estar
              #juntos!
				</p>
			</div>
			<Link to={"/"}>
